...
const Console = () => {
  ...
  const gameNames = ['Super Nintendo', 'Playstation 1', 'Xbox', 'HDMI Cable', 'HDMI Adapter', 'Retro Controller', 'Joystick Controller', 'Josytick Grip Cover', 'Double AA Battery', 'Rechargebale Battery Pack']

  const initialGames = Array(10).fill().map((_, i) => ({
    img: `/console/console${i + 1}.jpg`,
    name: gameNames[i] || `Nintendo Game ${i + 1}`,
    generation: `Gen ${((i % 3) + 1)}`,
  ...
  const handleCardClick = (game) => {
    navigate('/Console-Product', { state: { game } });
  }
              ...
              >
                ...
                <div className="game-details">
                  ...
                  <div className="game-info">
                    <span>Compatibility: {game.generation}</span>
