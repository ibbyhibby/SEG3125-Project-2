...
const Xbox = () => {
  ...
  const gameNames = ["Army Men: Sage's War", 'Arena Football', 'AA Army', 'American Chopper 2', 'AMF Bowling 2004', 'Amped2', "Blackstone: Magic & Steele", 'Bicycle Casino', 'Batman: Dark Tomorrow', 'Bruce Lee: Quest of The Dragon']

  const initialGames = Array(10).fill().map((_, i) => ({
    img: `/xbox/xbox${i + 1}.webp`,
    name: gameNames[i] || `Xbox Game ${i + 1}`,
  ...
  const handleCardClick = (game) => {
    navigate('/Xbox-Product', { state: { game } });
  }
